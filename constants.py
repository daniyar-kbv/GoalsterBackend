...
ACTIVATION_EMAIL_BODY_START_EN = '''
Hi!
...
'''
ACTIVATION_EMAIL_BODY_END_EN = '''
Follow us on Instagram: @goalsters
...
ACTIVATION_EMAIL_BODY_START_RU = '''
Привет!
...
'''
ACTIVATION_EMAIL_BODY_END_RU = '''
Будь подписан на нас в Инстаграм - @goalsters 
...
OBSERVATION_EMAIL_BODY_START_RU = '''
- Уважаемый пользователь,
...
OBSERVATION_EMAIL_BODY_START_EN = '''
- Dear user,
